...
def helpcmd(update, context):
    keyboard=ReplyKeyboardMarkup(keyboard=[[KeyboardButton(text="/search")],[KeyboardButton(text="/box")],[KeyboardButton(text="/despawn")],[KeyboardButton(text="/code")],[KeyboardButton(text="/help")]])
